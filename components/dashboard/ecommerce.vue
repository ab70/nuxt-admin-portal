<style>
@import url("~/public/assets/vendor/css/pages/app-ecommerce-dashboard.css");
</style>
<template>
    <!-- E commerce dashboard content Start -->
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">You have done 72% 😎 more sales today.<br> Check your new raising
                                    ...
                                    <div class="me-2 pe-1">
                                        <div class="avatar flex-shrink-0">
                                            <div class="avatar-initial bg-label-danger rounded">
                                                <div>
                                                    <img src="/assets/img/icons/unicons/paypal.svg" alt="paypal"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="d-flex mb-4 pb-2">
                                    <div class="me-2 pe-1">
                                        <div class="avatar flex-shrink-0">
                                            <div class="avatar-initial bg-label-success rounded">
                                                <div>
                                                    <img src="/assets/img/icons/unicons/credit-card.svg"
                                    ...
                                    <div class="me-2 pe-1">
                                        <div class="avatar flex-shrink-0">
                                            <div class="avatar-initial bg-label-warning rounded">
                                                <div>
                                                    <img src="/assets/img/icons/unicons/card-atm.svg" alt="paypal"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="d-flex mb-4 pb-2">
                                    <div class="me-2 pe-1">
                                        <div class="avatar flex-shrink-0">
                                            <div class="avatar-initial bg-label-primary rounded">
                                                <div>
                                                    <img src="/assets/img/icons/unicons/wallet.svg" alt="paypal"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="me-2 pe-1">
                                        <div class="avatar flex-shrink-0">
                                            <div class="avatar-initial bg-label-info rounded">
                                                <div>
                                                    <img src="/assets/img/icons/unicons/arrow-growth.svg"
                                                        alt="paypal" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
