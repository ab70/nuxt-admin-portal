                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card">
                        ...
                        <img src="/assets/img/icons/misc/triangle-light.png"
                            ...
                            data-app-dark-img="icons/misc/triangle-dark.html">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-truncate"><i
                                                class="mdi mdi-laptop mdi-24px text-danger me-1"></i> Admin</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate"><i
                                                class="mdi mdi-pencil-outline text-info mdi-24px me-1"></i> Editor</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate"><i
                                                class="mdi mdi-cog-outline text-warning mdi-24px me-1"></i> Author</td>
                                        <td><span class="badge bg-label-success rounded-pill">Active</span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate"><i
                                                class="mdi mdi-chart-donut mdi-24px text-success me-1"></i> Maintainer
                                        </td>
                                        <td><span class="badge bg-label-success rounded-pill">Active</span></td>
                                    </tr>
                                    <tr>
