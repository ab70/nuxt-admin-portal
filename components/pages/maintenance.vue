<style>
@import url("~/public/assets/vendor/css/pages/page-misc.css");
</style>
<template>
    <!-- Content -->
    ...
    <div class="misc-wrapper">
        ...
        <div class="d-flex justify-content-center mt-5">
            <img src="/assets/img/illustrations/tree-3.png" alt="misc-tree"
            ...
            <img src="/assets/img/illustrations/misc-mask-light.png" alt="misc-error"
                ...
                data-app-dark-img="illustrations/misc-mask-dark.html">
            <div class="d-flex flex-column align-items-center">
                <img src="/assets/img/illustrations/misc-under-maintenance.png" alt="misc-error"
                    class="img-fluid z-1" width="780">
                <div>
