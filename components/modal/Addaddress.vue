            ...
            <div class="col-12">
              <div class="row">
                <div class="col-md mb-md-0 mb-3">
                  <div
                    class="form-check custom-option custom-option-basic custom-option-label"
                  >
                    <label
                    ...
                    >
                      ...
                      <span class="custom-option-header">
                        <span class="h6 mb-0"
                          ><span class="mdi mdi-home me-2"></span>Home</span
                        >
                      </span>
                ...
                <div class="col-md mb-md-0 mb-3">
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="custom-option-header">
                        <span class="h6 mb-0"
                          ><span class="mdi mdi-home me-2"></span>Office</span
                        >
                      </span>
                      <span class="custom-option-body">
